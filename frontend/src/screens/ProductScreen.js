  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <Link to="/" className="btn btn-light mb-2 mr-2">
            Go Back
          </Link>
          ...
          <Row>
            <Col md={4}>
              <Image src={product.imgs} alt={product.title} fluid />
            </Col>
            <Col md={5}>
          ...
          <Row>
            <Col md={6}>
              <h2 className="mt-5 mb-3 text-secondary text-uppercase pl-3 border-left">
